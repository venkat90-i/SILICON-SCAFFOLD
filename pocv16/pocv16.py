...
class SilisIDE:
    def __init__(self, root):
        self.root = root
        self.root.title("Silis v27 (Anti-Recursion)")
        ...
        # --- NAVIGATION BINDINGS (Explorer Scope) ---
        self.tree.bind("<Control-z>", self.nav_back)
        self.tree.bind("<Control-y>", self.nav_forward)
        ...
        self.log_system(f"Silis v27 Ready. CWD: {self.cwd}", "SYS")
    ...
    # =========================================================================
    #                    PROJECT ORGANIZER LOGIC (FIXED: NO RECURSION)
    # =========================================================================
    ...
    def ensure_project_folder(self, target_base):
        ...
        # --- FIX: RECURSION CHECK ---
        # If we are already INSIDE the project folder, do nothing.
        if os.path.basename(self.cwd) == project_dir_name:
            return self.cwd
        ...
        # Only move files if they are in the current working directory (root of view)
