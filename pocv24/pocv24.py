...
class SilisIDE(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Silis QT v3.1 (Context File Manager)")
    ...
    # --- PORTED SURGICAL FILE MOVER (FROM POCV22) ---
    def prep_workspace(self, base):
        ...
        files_to_organize = [f"{base}.v", f"tb_{base}.v", f"{base}_tb.v", f"test_{base}.v"]
